...
displayButton.addEventListener('click', function handler() {
  ...
  displayButton.removeEventListener('click', handler);
}), {once : true};
...
function insultTheTheriocephalus() {
...
insultTheriButton.addEventListener('click', insultTheTheriocephalus);

insultUserButton.addEventListener('click', insultTheUser);

luckyButton.addEventListener('click', feelingLucky);

jauntyButton.addEventListener('click', feelingJaunty);
